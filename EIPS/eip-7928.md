...
The CL stores the BAL root using SSZ merkleization (`hash_tree_root(blockAccessList)`) in the ExecutionPayloadHeader.
...
The EL MUST retain BALs for at least 8192 blocks to support synchronization.
